...
export default function SubjectManagement() {
  ...
  const handleAddSubject = async () => {
    const newSubject = { academicYear, branch, subjectType, subjectCode, subjectName, credits };
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-100">
      ...
      <main className="flex-1 container mx-auto px-4 py-8">
        <h2 className="text-3xl font-bold text-center mb-6 text-gray-800">SUBJECT MANAGEMENT</h2>
          ...
          <tbody>
            {subjects.map((subject, index) => (
              <tr key={index} className="border-b">
                ...
                <td className="py-3 px-4 text-center">{subject.subjectType}</td>
                <td className="py-3 px-4 text-center">{subject.subjectCode}</td>
                <td className="py-3 px-4 text-center">{subject.subjectName}</td>
